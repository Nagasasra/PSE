...
String tagUID = "03 BF E8 1A";  // String to store UID of tag. Change it with your tag's UID
    ...
    if (RFIDMode == false) {
      ...
      if (i == 4) // If 4 keys are completed
      {
        ...
        if (!(strncmp(password, initial_password, 4))) // If password is matched
        {
          ...
          digitalWrite(solenoidPin, HIGH); // Door Opened
          digitalWrite(greenLed, HIGH);
          send_message("Door Opened \nIf it was't you, type 'close' to halt the system.");
          delay(3000);
          digitalWrite(greenLed, LOW);
          digitalWrite(solenoidPin, LOW); // Door Closed
          lcd.clear();
          i = 0;
...
void send_message(String message)
{
  ...
  delay(100);
  SIM900.println("AT+CMGS=\"+6281388320418\""); // Replace it with your mobile number
  delay(100);
